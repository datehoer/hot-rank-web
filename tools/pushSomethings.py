...
table = [
    {"id": 1, "name": "B站热榜", "tablename": "bilibili_hot"},
    {"id": 2, "name": "抖音热搜", "tablename": "douyin_hot"},
    {"id": 3, "name": "澎湃新闻", "tablename": "pengpai"},
    {"id": 4, "name": "掘金热榜", "tablename": "juejin_hot"},
    {"id": 5, "name": "少数派热榜", "tablename": "shaoshupai_hot"},
    {"id": 6, "name": "加密货币", "tablename": "crypto_coin"},
    {"id": 7, "name": "贴吧热议", "tablename": "tieba_topic"},
    {"id": 8, "name": "头条热榜", "tablename": "toutiao_hot"},
    {"id": 9, "name": "纽约时报", "tablename": "nytimes"},
    {"id": 10, "name": "华尔街日报", "tablename": "wsj"},
    {"id": 11, "name": "彭博新闻", "tablename": "bloomberg"},
    {"id": 12, "name": "金融时报", "tablename": "ft"},
    {"id": 13, "name": "微博热搜", "tablename": "weibo_hot_search"},
    {"id": 14, "name": "知乎热榜", "tablename": "zhihu_hot_list"},
    {"id": 15, "name": "虎扑社区热帖", "tablename": "hupu"},
    {"id": 16, "name": "历史上的今天", "tablename": "historytoday"},
    {"id": 17, "name": "华尔街见闻", "tablename": "wallstreetcn"},
    {"id": 18, "name": "要知", "tablename": "needknow"},
    {"id": 19, "name": "v2ex热门", "tablename": "v2ex"},
    {"id": 20, "name": "nodeseek", "tablename": "nodeseek"},
    {"id": 21, "name": "hostloc", "tablename": "hostloc"},
    {"id": 22, "name": "linuxdo", "tablename": "linuxdo"},
    {"id": 23, "name": "微信阅读排行榜", "tablename": "wx_read_rank"},
    {"id": 24, "name": "Yonhap News Agency", "tablename": "yna"},
    {"id": 25, "name": "Asahi Shimbun", "tablename": "asahi"},
    {"id": 26, "name": "Nippon Hōsō Kyōkai", "tablename": "nhk"},
    {"id": 27, "name": "Fox News", "tablename": "foxnews"},
    {"id": 28, "name": "Russia Today", "tablename": "rt"},
    {"id": 29, "name": "Le Monde", "tablename": "lemonde"},
    {"id": 30, "name": "Daily Mail", "tablename": "dailymail"},
    {"id": 31, "name": "Mumsnet", "tablename": "mumsnet"},
    {"id": 32, "name": "News.com.au", "tablename": "newsau"},
    {"id": 33, "name": "5Channel", "tablename": "fivech"},
    {"id": 34, "name": "Дзен", "tablename": "dzenru"},
    {"id": 35, "name": "36氪", "tablename": "36kr"},
    {"id": 36, "name": "52破解热榜", "tablename": "52pj"},
    {"id": 37, "name": "AcFun热榜", "tablename": "acfun"},
    {"id": 38, "name": "安全客安全快讯", "tablename": "anquanke"},
    {"id": 39, "name": "百度热搜", "tablename": "baidu_hot_search"},
    {"id": 40, "name": "白鲸出海", "tablename": "baijingchuhai"},
    {"id": 41, "name": "CSDN热榜", "tablename": "csdn"},
    {"id": 42, "name": "电商报最新消息", "tablename": "dianshangbao"},
    {"id": 43, "name": "第一财经热榜", "tablename": "diyicaijing"},
    {"id": 44, "name": "懂车帝热搜榜", "tablename": "dongchedi"},
    {"id": 45, "name": "豆瓣电影排行", "tablename": "douban_movie"},
    {"id": 46, "name": "FreeBuf咨询", "tablename": "freebuf"},
    {"id": 47, "name": "GitHub Trending", "tablename": "github"},
    {"id": 48, "name": "虎嗅热文", "tablename": "huxiu"},
    {"id": 49, "name": "3DM", "tablename": "3dm"},
    {"id": 50, "name": "IT之家热榜", "tablename": "ithome"},
    {"id": 51, "name": "开眼", "tablename": "openeye"},
    {"id": 52, "name": "看雪热门", "tablename": "kanxue"},
    {"id": 53, "name": "宽带山热榜", "tablename": "kuandaishan"},
    {"id": 54, "name": "PMCAFF精选", "tablename": "pmcaff"},
    {"id": 55, "name": "汽车之家热帖榜", "tablename": "qichezhijia"},
    {"id": 56, "name": "起点榜单", "tablename": "qidian"},
    {"id": 57, "name": "水木社区热门话题", "tablename": "shuimu"},
    {"id": 58, "name": "新浪热门", "tablename": "sina"},
    {"id": 59, "name": "新浪体育热门", "tablename": "sina_sport"},
    {"id": 60, "name": "新浪新闻热门", "tablename": "sina_news"},
    {"id": 61, "name": "太平洋汽车热门", "tablename": "taipingyang"},
    {"id": 62, "name": "TapTap热门", "tablename": "taptap"},
    {"id": 63, "name": "腾讯新闻热点榜", "tablename": "tencent_news"},
    {"id": 64, "name": "人人都是产品经理热门", "tablename": "woshipm"},
    {"id": 65, "name": "易车热门", "tablename": "yiche"},
    {"id": 66, "name": "优设读报", "tablename": "youshedubao"},
    # {"id": 67, "name": "游戏葡萄文章推荐", "tablename": "youxiputao"},
    {"id": 68, "name": "站酷榜单", "tablename": "zhanku"},
    {"id": 69, "name": "纵横24小时畅销榜", "tablename": "zongheng"},
    {"id": 70, "name": "hacknews", "tablename": "hacknews"},
    # {"id": 71, "name": "酷安热门话题", "tablename": "coolan"},
    # {"id": 72, "name": "雪球热门", "tablename": "xueqiu"},
    # {"id": 73, "name": "Google 热搜", "tablename": "google_search"},
]

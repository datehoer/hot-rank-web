...
table = [
    ...
    {"name": "News Yc", "tablename": "hacknews"},
    # {"name": "豆瓣电影一周口碑榜", "tablename": "douban_movie"},
    # {"name": "豆瓣电影北美票房榜", "tablename": "douban_movie"},
    {"name": "安全内参", "tablename": "secrss"},
    {"name": "The Hacker News", "tablename": "thehackernews"},
    {"name": "Steam热销榜", "tablename": "steam"},
    {"name": "爱范儿", "tablename": "ifanr"},
    {"name": "Google News头条", "tablename": "googlenews"},
    {"name": "金十数据", "tablename": "jin10"},
    {"name": "雪球热帖", "tablename": "xueqiu"},
    {"name": "酷安热榜", "tablename": "coolan"},
